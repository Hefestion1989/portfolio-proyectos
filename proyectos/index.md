...
Mapa público de herramientas, prototipos y repositorios vinculados al laboratorio digital.

## Repos principales

- [`laboratorio-digital`](https://github.com/Hefestion1989/laboratorio-digital)  
  Base completa de trabajo: archivo, notas, prototipos, utilidades y organización general.

- [`portfolio-proyectos`](https://github.com/Hefestion1989/portfolio-proyectos)  
  Vitrina pública para recorrer proyectos, notas y trabajos sin entrar en la estructura interna del laboratorio.
...
- [Ensayos sobre IA, consciencia y sociedad](../notas/ia-y-consciencia/): colección académica sobre IA, consciencia, subjetividad, gobernanza tecnológica y sociedad.

## Criterio

- Esta página muestra qué mirar primero.
- El código y los materiales de trabajo viven en sus repos o dentro de `laboratorio-digital`.
- La vitrina prioriza claridad pública antes que detalle técnico.
